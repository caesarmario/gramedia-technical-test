...
BASE_URL: str     = Variable.get("FAKESTORE_BASE_URL")
...
def _run_extract(exec_ds: str, **_) -> None:
    ...
    cmd = [
        "python", "-m", f"scripts.extract.extract_products",
        "--ds", exec_ds,
        "--base-url", BASE_URL,
...
with DAG(
    dag_id="00_01_dag_fakestore_extract_products",
    ...
    t10_run = PythonOperator(
        task_id="t10_run_extract_products",
