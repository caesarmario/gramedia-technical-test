...
def _run_transform(exec_ds: str, **_: Dict[str, Any]) -> None:
    ...
    config_path = f"schema_config/fakestore_raw/products_schema_config.json"

    cmd = [
        "python", "-m", f"scripts.transform.transform_products_to_parquet",
        "--ds", exec_ds,
...
with DAG(
    dag_id="01_01_dag_fakestore_transform_products",
    ...
    t20_run = PythonOperator(
        task_id="t20_run_transform_products",
